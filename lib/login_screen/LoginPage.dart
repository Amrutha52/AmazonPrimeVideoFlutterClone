...
import '../view/username_screen/UserNameScreen.dart';
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            //Provider.of<Authenticate>(context, listen: false).signIn(_emailController.text.trim(), _passwordController.text.trim());
                          }
                        },
